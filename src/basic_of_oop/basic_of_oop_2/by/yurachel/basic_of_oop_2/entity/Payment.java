package basic_of_oop.basic_of_oop_2.by.yurachel.basic_of_oop_2.entity;
...
// Создаем внутренний класс
   ...
   public void addPurchase(String purchaseName, int prices){
        this.purchaseList.add(new Purchase(purchaseName,prices));
   }
